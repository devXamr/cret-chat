...
export function Landing(){
    ...
    return <div className='overflow-scroll h-screen bg-gradient-to-b from-gray-900 via-indigo-900 to-purple-800'>
        <div className='font-logo text-purple-700 text-center text-3xl pt-5'>Tempchat</div>
        <div className='text-white font-sans text-4xl text-center pr-5 pl-5 pt-36'>Say <span className='font-bold'>Goodbye</span> To Dead Groupchats</div>
